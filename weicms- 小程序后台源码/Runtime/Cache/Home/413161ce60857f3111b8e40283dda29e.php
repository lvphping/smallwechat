...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="wrap">
       ...
       <?php if(!empty($userInfo[website_logo])): ?><img height="52" src="<?php echo (get_cover_url($userInfo["website_logo"])); ?>"/>
       	<?php else: ?>
       		<img height="52" src="/weicms/Public/Home/images/logo.png"/><?php endif; ?>
       </a>
      ...
      <?php $index_2 = strtolower ( MODULE_NAME . '/' . CONTROLLER_NAME . '/*' ); $index_3 = strtolower ( MODULE_NAME . '/' . CONTROLLER_NAME . '/' . ACTION_NAME ); ?>
            ...
            <div class="top_nav">
                <?php if(is_login()): ?><ul class="nav" style="margin-right:0">
                    		<?php if($myinfo[is_audit]==0 && ! $reg_audit_switch): ?><li><p>该账号配置信息已提交，请等待审核</p></li>
                        ...
                        <li class="dropdown admin_nav">
                            <a href="#" class="dropdown-toggle login-nav" data-toggle="dropdown" style="">
                                ...
                                <?php else: ?>
                                    <img class="admin_head default" src="/weicms/Public/Home/images/default.png"/><?php endif; ?>
  ...
  <div class="admin_container">
    <section id="contents" class="tab-content">
      <div class="table-bar">
        ...
        <?php if(is_array($notices)): $i = 0; $__LIST__ = $notices;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nt): $mod = ($i % 2 );++$i;?><p><a href="<?php echo U('notice_detail', array('id'=>$nt['id']));?>" target="_blank">◆ <?php echo ($nt["title"]); ?></a></p><?php endforeach; endif; else: echo "" ;endif; ?>
        </div><?php endif; ?>
...
(function(){
	var ThinkPHP = window.Think = {
		"ROOT"   : "/weicms", //当前网站地址
		"APP"    : "/weicms/index.php?s=", //当前项目地址
		"PUBLIC" : "/weicms/Public", //项目公共目录地址
